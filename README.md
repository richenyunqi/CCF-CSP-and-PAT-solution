...
本仓库是书籍《算法详解（C++11 语言描述）》（预计 2021 年 5 月左右出版）的配套仓库，主要负责更新 CCF CSP 和 PAT 顶级甲级乙级题解代码。由于 CCF CSP 和 PAT 考试都已支持 C++14 标准，本仓库的所有题解代码均将基于 C++14 语法编写。在编译本仓库的代码之前，最好选择支持 C++14 的编译环境。
